	...
	<view class="container">
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="userInfo.userInfo.icon || '/static/missing-face.png'" v-if="userInfo">
					</image>
			...
			<view class="vip-card-box">
				...
				<text class="e-b">一款云端运行的iOS云手机APP,本机即使关机,在云手机上面照样升级，免越狱手游辅助让您玩的手游副本任务效率事办功倍！</text>
			</view>
		</view>
		...
		<view class="cover-container" :style="[{
			...
			<view class="tj-sction">
				<view class="tj-item">
					<text class="tj-item-name">账号</text>
					<text class="tj-item-value">2601972538</text>
				</view>
				<view class="tj-item">
					<text class="tj-item-name">成长</text>
					<text class="tj-item-value">0</text>
				</view>
				<view class="tj-item">
					<text class="tj-item-name">云币</text>
					<text class="tj-item-value">0.00</text>
				</view>
			</view>
			<!-- 订单 -->
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-fenlei" iconColor="#e07472" title="每日活动" tips="每日大礼等你来拿哦" @eventClick="dailyActivities"></list-cell>
				<list-cell icon="icon-share" iconColor="#e07472" title="分享好友" tips="邀请好友赢10万大礼"></list-cell>
