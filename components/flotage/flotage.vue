<template>
	...
	<view class="content">
		<view
			:style="{'transform':'translate3d('+xMove * 2+'rpx,'+yMove * 2+'rpx,0)',right:right * 2+'rpx',bottom:bottom * 2 +'rpx'}"
			class="touch" @touchstart="handleStart" @touchmove="handleMove" @touchend="handleEnd" @click="parCallback">
